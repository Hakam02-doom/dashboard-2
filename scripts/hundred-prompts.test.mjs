...
test('the shared $30 ceiling stops new paid requests even if configured higher',async()=>{
 let network=0;const state={answers:[],analysisAttempts:600,attempts:0};const store={kind:'test',load:async()=>state,save:async()=>{},acquire:async()=>true,release:async()=>{}};
